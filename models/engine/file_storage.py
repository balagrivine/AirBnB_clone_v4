...
class FileStorage:
    ...
    def all(self, cls=None):
        """this returns private attribute: __objects"""
        if cls:
            objects_dict = {}
    ...
    def close(self):
        """
            this calls the reload() method for deserialization from JSON to objects
        """
        self.reload()
